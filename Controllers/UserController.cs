    ...
    public class UserController : Controller
    {
                ...
                else
                {
                    if (result.PassWord == Encryptor.MD5Hash(model.PassWord))
                    {
                        ...
                        else
                        {
                            ...
                            SetAlert("Vui lòng kích hoạt tài khoản", "warning");
        ...
        public ActionResult ConfirmRegister(string Code, string UserName)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    SetAlert("Kích hoạt tài khoản không thành công", "error");
                }
            }
        ...
        public ActionResult ForgotPassWord(RegisterModel model)
        {
            ...
            if (user != null)
            {
                ...
                user.Code = code;
                db.SaveChanges();
                ModelState.AddModelError("", "Vui lòng kiểm tra trong email");
            }
            else
            {
        ...
        { 
            ...
            if (sess != null)
            {
                ...
                user.Code = code;
                db.SaveChanges();
                SetAlert("Đã gửi code vào mail bạn", "success");
